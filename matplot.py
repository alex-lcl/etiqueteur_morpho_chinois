...
if __name__ == '__main__':
    #main(Path("/home/tim/Document/rnn"))
	#main(Path("/home/tim/Document/lstm"))
    #main(Path("/home/tim/Document/gru"))
    main(Path("/home/tim/Document/rnn_embedding"))
    main(Path("/home/tim/Document/lstm_embedding"))
    main(Path("/home/tim/Document/gru_embedding"))